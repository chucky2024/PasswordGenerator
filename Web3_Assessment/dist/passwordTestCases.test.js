...
describe('generateRandomPassword', () => {
    ...
    */
    test('generates a password with only uppercase letters', () => {
        const password = (0, generatePassword_1.default)(10, {
            uppercase: true,
        });
    ...
    */
    test('generates a password with only lowercase letters', () => {
        const password = (0, generatePassword_1.default)(12, {
            lowercase: true,
        });
    ...
    */
    test('generates a password with only numbers', () => {
        const password = (0, generatePassword_1.default)(8, {
            numbers: true,
        });
    ...
    */
    test('generates a password with only special characters', () => {
        const password = (0, generatePassword_1.default)(6, {
            specialChars: true,
        });
        expect(password.length).toBe(6);
        expect(containsOnly(password, GENERATOR_CONFIG.specialChars)).toBe(true);
    });
    /**
    |--------------------------------------------------
    ...
    */
    test('generates a password with a mix of all character types', () => {
        const password = (0, generatePassword_1.default)(16, {
            uppercase: true,
            lowercase: true,
            numbers: true,
            specialChars: true,
